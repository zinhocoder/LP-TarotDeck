...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0A1F33] text-white overflow-hidden">
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="flex flex-col items-center md:flex-row md:items-start gap-10 max-w-4xl mx-auto">
            <div className="w-full md:w-1/3 flex flex-col items-center">
              <div className="relative w-48 h-48 mb-4 overflow-hidden rounded-full border-4 border-[#FFD700]/30 shadow-[0_0_20px_rgba(255,215,0,0.2)]">
              ...
              <div className="flex space-x-3 mt-4">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full border-[#FFD700]/30 text-[#FFD700] hover:bg-[#FFD700]/10"
                >
                  <svg
            ...
            <div className="w-full md:w-2/3">
              <div className="p-6 rounded-lg bg-[#0A1F33]/60 border border-[#FFD700]/20 shadow-[0_0_15px_rgba(255,215,0,0.1)]">
                ...
                <p className="mb-4 text-gray-200">
                  Márcio é um renomado tarólogo e terapeuta holístico com mais de 15 anos de experiência na prática e
                  ensino do Tarot como ferramenta de autoconhecimento e transformação pessoal.
                </p>

                <p className="mb-4 text-gray-200">
                  Sua abordagem única combina o conhecimento tradicional dos Arcanos com técnicas modernas de
                  desenvolvimento espiritual, criando um método acessível e profundo para conectar-se com a sabedoria
                  ancestral do Tarot.
                </p>

                <p className="mb-4 text-gray-200">
                  Através de seus cursos e consultas, já ajudou milhares de pessoas a encontrarem clareza, propósito e
                  direção em suas vidas, utilizando o Tarot como uma poderosa ferramenta de autoconhecimento.
                </p>
                ...
                <div className="flex mt-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Compartilhar conhecimento espiritual de forma acessível e transformadora
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container px-4 mx-auto">
          <div className="grid gap-8 md:grid-cols-2">
            <div className="p-8 text-center rounded-lg bg-gradient-to-br from-[#1A2C4D] to-[#2A3C5D] border border-[#FFD700]/20 shadow-[0_10px_30px_rgba(0,0,0,0.3)] hover:shadow-[0_15px_40px_rgba(0,0,0,0.4),0_0_20px_rgba(255,215,0,0.2)] transition-all duration-300 group flex flex-col h-full justify-between">
              ...
              <h3 className="mb-4 text-3xl font-bold text-white group-hover:text-[#FFD700]">Bônus Exclusivo</h3>
              <div className="p-4 mb-6 rounded-lg bg-[#0A1F33]/50">
                <p className="mb-4 text-xl text-gray-200">
                  Ao adquirir o eBook, ganhe uma <span className="text-[#FFD700] font-semibold">meditação guiada</span>{" "}
                  para conectar-se aos Arcanos!
                </p>
                <p className="text-gray-300">
                  Um áudio exclusivo que vai potencializar sua conexão energética com as cartas e ampliar sua intuição.
                </p>
              </div>
              <Button
      ...
      {/* CTA Final - Melhorada */}
      <section className="py-20 text-center bg-gradient-to-b from-[#1A2C4D] to-[#0A1F33] relative">
        {/* Elementos decorativos */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-20 pointer-events-none">
